...
export default function Notifications() {
  ...
  return (
    <div className="p-6">
      ...
      <h1 className="text-2xl font-bold mb-4">Notifications des entretiens dans Entretiens</h1>
      ...
      <ul className="space-y-3">
        ...
        {notifications.map((n: any) => (
          <li key={n.id} className={`p-3 border rounded ${n.read_at ? 'bg-black' : 'bg-ray-500'}`}>
